...
/***/ function(module, exports, __webpack_require__) {
	...
	var _words = __webpack_require__(191);
	...
	var Page = exports.Page = function (_React$Component) {
	    ...
	    function Page() {
	        ...
	        _this.selectList = 'MounceCh1';
	        _this.words = _this.getWordList();
	        _this.wordIndex = 0;
	        _this.vocabularyList = _words.Vocabulary.List;
	    ...
	    _createClass(Page, [{
	        ...
	        value: function getWordList() {
	            var wordlist = _words.Vocabulary[this.selectList];
	        ...
	        key: 'handleShowDef',
	        value: function handleShowDef(e) {
	            e.preventDefault();
	            document.getElementById('cardface').style.display = "none";
	            document.getElementById('answer').style.display = "block";
	        }
	    }, {
	        key: 'handleGetNextWord',
	        value: function handleGetNextWord(e) {
	            e.preventDefault();
	            //get next word
	            document.getElementById('cardface').style.display = "block";
	            document.getElementById('answer').style.display = "none";
	        ...
	        key: 'pickVocabList',
	        value: function pickVocabList(e) {
	            e.preventDefault();
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        'select',
	                        { className: 'selectList', id: 'selectVocabList' },
	                        vocabLists
	                    ),
	                    _react2.default.createElement(
	                        'button',
	                        { className: 'button button-blue', onClick: function onClick(e) {
	                                return _this2.pickVocabList(e);
	                            } },
	                        'Change Lists'
	                    )
	                ),
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        this.words[this.wordIndex].numOfTimesInNT,
	                        'x'
	                    ),
	                    _react2.default.createElement('div', { className: 'clear-floats' }),
	                    _react2.default.createElement(
	                        'h2',
	                        { id: 'cardface', className: 'text-center drop-down' },
	                        this.words[this.wordIndex].word
	                    ),
	                    _react2.default.createElement(
	                        'div',
	                        { id: 'answer', style: {
	                        ...
	                        _react2.default.createElement(
	                            ...
	                            this.words[this.wordIndex].definition
	                        ),
	                        ...
	                        _react2.default.createElement(
	                            ...
	                            this.words[this.wordIndex].definiteArticle
	                        ),
	                        _react2.default.createElement('br', null),
	                        _react2.default.createElement(
	                            'h3',
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement(
	                            'button',
	                            { className: 'button button-blue', onClick: function onClick(e) {
	                                    return _this2.handleGetNextWord(e);
	                                } },
	                            'Next Word'
	                        )
	                    )
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/less-loader/index.js!./flashcard.less", function() {
				var newContent = require("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/less-loader/index.js!./flashcard.less");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "#flashcard {\n  height: 82%;\n  box-shadow: 0 2px 2px 0 rgba(0, 0, 0, 0.14), 0 3px 1px -2px rgba(0, 0, 0, 0.2), 0 1px 5px 0 rgba(0, 0, 0, 0.12);\n  background-color: #fafafa;\n  margin: 8px;\n  position: relative;\n  border-radius: 2px;\n}\n@media only screen and (min-width: 768px) {\n  #flashcard {\n    width: 768px;\n    margin-left: auto;\n    margin-right: auto;\n  }\n}\n", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/less-loader/index.js!./clear-floats.less", function() {
				var newContent = require("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/less-loader/index.js!./clear-floats.less");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".clear-floats {\n  clear: both;\n}\n", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/less-loader/index.js!./pull-right.less", function() {
				var newContent = require("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/less-loader/index.js!./pull-right.less");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".pull-right {\n  float: right;\n}\n", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/less-loader/index.js!./text-center.less", function() {
				var newContent = require("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/less-loader/index.js!./text-center.less");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/less-loader/index.js!./hide.less", function() {
				var newContent = require("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/less-loader/index.js!./hide.less");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/less-loader/index.js!./fontstyles.less", function() {
				var newContent = require("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/less-loader/index.js!./fontstyles.less");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".italics {\n  font-style: italic;\n}\n", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/less-loader/index.js!./inputstyles.less", function() {
				var newContent = require("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/less-loader/index.js!./inputstyles.less");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports) {
	...
	var Vocabulary = exports.Vocabulary = {
	    List: ['MounceCh1', 'MounceCh2'],
	    MounceCh1: [{
	        id: 1,
	        word: "Ἀβραάμ",
	        definition: "Abraham",
	        ...
	        id: 3,
	        word: "ἀμήν",
	        definition: "verily, truly, amen, so let it be",
	        definiteArticle: "",
	        numOfTimesInNT: 129,
	        otherWordForms: ""
	    }, {
	        id: 4,
	        word: "ἄνθρωπος",
	        definition: "man, mankind, person, people, humankind, human being",
	        definiteArticle: "ὁ",
	        numOfTimesInNT: 550,
	        otherWordForms: ""
	    }, {
	        id: 5,
	        word: "ἀπόστολος",
	        definition: "apostle, envoy, messenger",
	        definiteArticle: "ὁ",
	        numOfTimesInNT: 80,
	        otherWordForms: ""
	    }, {
	        ...
	        id: 16,
	        word: "κόσμος",
	        definition: "world, universe, humankind",
	        definiteArticle: "ὁ",
	        numOfTimesInNT: 186,
	        otherWordForms: ""
	    }, {
	        id: 17,
	        word: "λόγος",
	        definition: "word, Word, statement, message",
	        definiteArticle: "ὁ",
	        numOfTimesInNT: 330,
	        otherWordForms: ""
	    }, {
	        ...
	        id: 21,
	        word: "πνεῦμα",
	        definition: "spirit, Spirit, wind, breath, inner life",
	        definiteArticle: "τό",
	        numOfTimesInNT: 379,
	        otherWordForms: ""
	    }, {
